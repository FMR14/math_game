...
if st.session_state.quiz_started:
    ...
    user_answer = st.number_input("Enter your answer:", value=None, step=1, placeholder="Type your answer here")
    
    if st.button("Check Answer") and user_answer is not None:
